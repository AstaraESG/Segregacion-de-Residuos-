...
Cáscara de verdura,organico,cascara de papa|cascara de zanahoria|verdura|vegetal|semillas|cascara de mani|cascaras de frutos secos,
"Restos de jardín, poda o plantas secas",organico,poda|restos de jardin|hojas secas|ramas|plantas secas|flores marchitas|arreglo floral|cesped|viruta de sacapuntas|aserrin,
...
Envoltura o empaque de snacks y galletas,general,envoltura|empaque de snack|bolsa de snack|paquete de papas|paquete de galletas|envoltorio metalizado|piqueo|bolsa de piqueo|snack|snacks|empaque de sandwich|empaque de chocolate|empaque de caramelos|empaque de alfajor|empaque de brownie|empaque de muffin|empaque de dona|empaque de croissant|empaque de galleton|empaque de frutos secos|empaque de cancha|empaque de gomitas|empaque de chicle|empaque de barra energetica|empaque de avena|empaque de cereal|empaque de granola|chocolate|caramelo|caramelo envuelto|galleta|dulce|postre|cupcake|malvavisco|wrapper|barra de cereal|bolsa metalizada,Son laminados mixtos de plástico y aluminio que no se pueden separar.
"Sachet de salsa, azúcar o condimento",general,sachet|sobre de salsa|mayonesa|ketchup|paquete de azucar|paquete de sal|paquete de mostaza|paquete de aji|paquete de mermelada|paquete de mantequilla|empaque de cafe|empaque de te|bolsa de cafe,"Son sobres pequeños de plástico y aluminio que no se pueden separar."
Envase rígido de snacks (Ejemplo: Pringles),general,pringles|lata de pringles|tubo de papas,"Combina cartón, metal y plástico en una sola pieza, por eso no se puede separar."
